...
!!! Tip
	参考链接：[https://learn.microsoft.com/zh-cn/dotnet/framework/data/adonet/connection-strings-and-configuration-files](https://learn.microsoft.com/zh-cn/dotnet/framework/data/adonet/connection-strings-and-configuration-files) 
